...
- Best result: `unsw_nb15 / xgb / pgd`, transfer_success_rate = `0.5803`.

## Best attack per dataset

- `unsw_nb15`: `xgb / pgd` = `0.5803`
- `nsl_kdd`: `xgb / pgd` = `0.5339`
...
- `nsl_kdd / xgb`: `pgd`, transfer = `0.5339`, accuracy_drop = `0.5257`, macro_f1_drop = `0.6561`
